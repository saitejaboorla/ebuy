				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="ebuy"><img src="images/suncart.png" alt="ebuy" /></a></li>
				
						</ul>
					</div>	<p>&copy; ebuy.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To ebuy Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2014 ebuy.com All rights reserved. The information contained in ebuy.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of ebuy.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
