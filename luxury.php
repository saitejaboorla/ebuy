...
You can be confident when you're shopping online with ebuy. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us, such as personal information, in an encrypted envelope, making it extremely difficult for this information to be intercepted.<p></p>
		  ...
		  <div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689672840_Ramayana.jpg"></div><div class="product-content"><h2><b>Traditional Pattachitra</b> </h2><div class="product-desc">Ramayana Full Story</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹42500</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="87"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689672960_Globe Elephant.jpg"></div><div class="product-content"><h2><b>Iron Elephant Design with Globe</b> </h2><div class="product-desc">Made in India</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹190000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="88"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673020_Tara Sculpture.jpg"></div><div class="product-content"><h2><b>Tara Sculpture</b> </h2><div class="product-desc">Inspired by Goddess</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹29999</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="89"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673080_Wooden Box.jpg"></div><div class="product-content"><h2><b>Nikolai Teak Box</b> </h2><div class="product-desc">Completely Wood</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹48000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="90"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673200_Chess.jpg"></div><div class="product-content"><h2><b>Marble Chess Board with Metal Pawn</b> </h2><div class="product-desc">Italian Marble</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹45000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="91"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673320_Diya stand.jpg"></div><div class="product-content"><h2><b>Antique Brass Bird Diya Stand</b> </h2><div class="product-desc">home iconic décor</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹574000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="92"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673380_Garuda.jpg"></div><div class="product-content"><h2><b>Wooden Garuda on Base</b> </h2><div class="product-desc">Garuda Idol</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹221000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="93"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673440_Wall Photo.jpg"></div><div class="product-content"><h2><b>Gwal Swaroop Shri Gokulchandramaji</b> </h2><div class="product-desc">	Wall Photograph</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹180000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="94"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
			<div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673500_Buddha.jpg"></div><div class="product-content"><h2><b>Brass Buddha Artifact</b> </h2><div class="product-desc">Completely Brass</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹134000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="95"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
            <div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673620_Photo.jpg"></div><div class="product-content"><h2><b>Shri Nathji Laal Bagh Pichwai Painting</b> </h2><div class="product-desc">Painting</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹22400</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="97"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
            <div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673680_Chandlier.jpg"></div><div class="product-content"><h2><b>24 Lights Clarissa Chandelier</b> </h2><div class="product-desc">exudes elegance</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹104000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="98"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>
            <div class="grid_1_of_4 images_1_of_4"><form method="post" action="cart_update.php"><div class="product-thumb"><img src="images\1689673740_Brass Flower.jpg"></div><div class="product-content"><h2><b>Luxe Me Lotus Mirror</b> </h2><div class="product-desc">Brass (Large)</div><div class="product-info"><p><span class="price"> Price:<big style="color:green">₹72000</big></span></p>Qty <input type="text" name="product_qty" value="1" size="3"><div class="button"><span><img src="images/cart.jpg" alt=""><button class="cart-button">Add to Cart</button></span> </div></div></div><input type="hidden" name="Product_ID" value="99"><input type="hidden" name="type" value="add"><input type="hidden" name="return_url" value="aHR0cDovL2xvY2FsaG9zdC9lYnV5L2luZGV4LnBocA=="></form></div>    </div>
